...
import 'package:flutter/material.dart' show Theme, ThemeData, debugCheckHasMaterialLocalizations;

// The over-scroll distance that moves the indicator to its maximum
// displacement, as a percentage of the scrollable's container extent.
double _kDragContainerExtentPercentage = 0.25;

// How much the scroll's drag gesture can overshoot the RefreshIndicator's
// displacement; max displacement = _kDragSizeFactorLimit * displacement.
double _kDragSizeFactorLimit = 1.5;

// When the scroll ends, the duration of the refresh indicator's animation
// to the RefreshIndicator's displacement.
Duration _kIndicatorSnapDuration = Duration(milliseconds: 150);

// The duration of the ScaleTransition that starts when the refresh action
// has completed.
Duration _kIndicatorScaleDuration = Duration(milliseconds: 200);

/// The signature for a function that's called when the user has dragged a
/// [EnhancedRefreshIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [EnhancedRefreshIndicator.onRefresh].
typedef RefreshCallback = Future<void> Function();
typedef EnhancedRefresherBuilder = Widget Function(Animation<double> animation);
...
/// Used to configure how [EnhancedRefreshIndicator] can be triggered.
...
///
/// The trigger mode is configured by [EnhancedRefreshIndicator.triggerMode].
///
/// {@tool dartpad}
/// This example shows how [EnhancedRefreshIndicator] can be triggered in different ways.
///
/// ** See code in examples/api/lib/material/refresh_indicator/refresh_indicator.0.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// This example shows how to trigger [EnhancedRefreshIndicator] in a nested scroll view using
...
///
/// The [EnhancedRefreshIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [EnhancedRefreshIndicator] will always appear, even if the
...
/// ```
///
/// A [EnhancedRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [EnhancedRefreshIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [EnhancedRefreshIndicator] to show
...
class EnhancedRefreshIndicator extends StatefulWidget {
  ...
  EnhancedRefreshIndicator({
    super.key,
    required this.child,
    required this.refresherBuilder,
  ...
  /// Creates an adaptive [EnhancedRefreshIndicator] based on whether the target
  ...
  EnhancedRefreshIndicator.adaptive({
    super.key,
    required this.child,
    required this.refresherBuilder,
    this.displacement = 40.0,
  ...
  final EnhancedRefresherBuilder refresherBuilder;
  ...
  /// Defines how this [EnhancedRefreshIndicator] can be triggered when users overscroll.
  ///
  /// The [EnhancedRefreshIndicator] can be pulled out in two cases,
...
/// Contains the state for a [EnhancedRefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class EnhancedRefreshIndicatorState extends State<EnhancedRefreshIndicator> with TickerProviderStateMixin<EnhancedRefreshIndicator> {
  ...
  @override
  void didUpdateWidget(covariant EnhancedRefreshIndicator oldWidget) {
  ...
  bool _shouldStart(ScrollNotification notification) {
    ...
    return ((notification is ScrollStartNotification && notification.dragDetails != null) || (notification is ScrollUpdateNotification && notification.dragDetails != null && widget.triggerMode == RefreshIndicatorTriggerMode.anywhere)) && ((notification.metrics.axisDirection == AxisDirection.up && notification.metrics.extentAfter == 0.0) || (notification.metrics.axisDirection == AxisDirection.down && notification.metrics.extentBefore == 0.0)) && _mode == null && _start(notification.metrics.axisDirection);
  }
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    ...
    if (indicatorAtTopNow != _isIndicatorAtTop) {
      ...
      if (_mode == _RefreshIndicatorMode.drag || _mode == _RefreshIndicatorMode.armed) {
        if ((notification.metrics.axisDirection == AxisDirection.down && notification.metrics.extentBefore > 0.0) || (notification.metrics.axisDirection == AxisDirection.up && notification.metrics.extentAfter > 0.0)) {
          _dismiss(_RefreshIndicatorMode.canceled);
        } else {
  ...
  ///
  /// Creating the [EnhancedRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [EnhancedRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [EnhancedRefreshIndicator.onRefresh] callback's future completes.
  ///
                ...
                child: ScaleTransition(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? _) {
                      final Widget materialIndicator = widget.refresherBuilder(_value);
