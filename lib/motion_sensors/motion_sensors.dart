...
class MotionSensors {
  ...
  static const int tYPEORIENTATION = 15; //=TYPE_GAME_ROTATION_VECTOR
  static const int tYPEABSOLUTEORIENTATION = 11; //=TYPE_ROTATION_VECTOR
  ...
  set accelerometerUpdateInterval(int interval) =>
      setSensorUpdateInterval(tYPEACCELEROMETER, interval);
  ...
  set absoluteOrientationUpdateInterval(int interval) =>
      setSensorUpdateInterval(tYPEABSOLUTEORIENTATION, interval);
